...
# ==================================================
# Link Hosting Kalian
arlanstore="raw.githubusercontent.com/arlanstore/arvpn/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/arlanstore/arvpn/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/arlanstore/arvpn/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/arlanstore/arvpn/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
