...
mkdir /data
wget -O /data/tls.pem "https://raw.githubusercontent.com/arlanstore/arvpn/main/vmess/certi.pem"
wget -O /data/tls.key "https://raw.githubusercontent.com/arlanstore/arvpn/main/vmess/certi.key"
